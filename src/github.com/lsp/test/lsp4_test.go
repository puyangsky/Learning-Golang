...
func newSyncTestSystem(t *testing.T, numClients, numMsgs int, mode syncTestMode, params *lsp.Params) *syncTestSystem {
	...
	ts.numMsgs = numMsgs
	ts.clients = make([]lsp.Client, numClients)
...
func (ts *syncTestSystem) runServer() {
	t := ts.t
	srv, err := lsp.NewServer(ts.port, ts.params)
	if err != nil {
...
func (ts *syncTestSystem) runClient(clienti int) {
	...
	cli, err := lsp.NewClient(hostport, ts.params)
	if err != nil {
...
func TestServerFastClose1(t *testing.T) {
	newSyncTestSystem(t, 1, 10, doServerFastClose, &lsp.Params{5, 500, 1}).
...
func TestServerFastClose2(t *testing.T) {
	newSyncTestSystem(t, 3, 10, doServerFastClose, &lsp.Params{5, 500, 1}).
...
func TestServerFastClose3(t *testing.T) {
	newSyncTestSystem(t, 5, 500, doServerFastClose, &lsp.Params{5, 2000, 1}).
...
func TestServerToClient1(t *testing.T) {
	newSyncTestSystem(t, 1, 10, doServerToClient, &lsp.Params{5, 500, 1}).
...
func TestServerToClient2(t *testing.T) {
	newSyncTestSystem(t, 3, 10, doServerToClient, &lsp.Params{5, 500, 1}).
...
func TestServerToClient3(t *testing.T) {
	newSyncTestSystem(t, 5, 500, doServerToClient, &lsp.Params{5, 2000, 1}).
...
func TestClientToServer1(t *testing.T) {
	newSyncTestSystem(t, 1, 10, doClientToServer, &lsp.Params{5, 500, 1}).
...
func TestClientToServer2(t *testing.T) {
	newSyncTestSystem(t, 3, 10, doClientToServer, &lsp.Params{5, 500, 1}).
...
func TestClientToServer3(t *testing.T) {
	newSyncTestSystem(t, 5, 500, doClientToServer, &lsp.Params{5, 2000, 1}).
...
func TestRoundTrip1(t *testing.T) {
	newSyncTestSystem(t, 1, 10, doRoundTrip, &lsp.Params{5, 500, 1}).
...
func TestRoundTrip2(t *testing.T) {
	newSyncTestSystem(t, 3, 10, doRoundTrip, &lsp.Params{5, 500, 1}).
...
func TestRoundTrip3(t *testing.T) {
	newSyncTestSystem(t, 5, 500, doRoundTrip, &lsp.Params{5, 2000, 1}).
